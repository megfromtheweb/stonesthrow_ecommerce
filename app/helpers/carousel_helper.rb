...
module CarouselHelper
  ...
  class Carousel
    ...
    def control_tag(direction)
      ...
      spans = safe_join([content_tag(:span, nil, class: "carousel-control-#{direction}-icon", "aria-hidden": true),
                         content_tag(:span, direction == "prev" ? "Previous" : "Next", class: "visually-hidden")])
